...
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) 
    VALUES ('Ramon Wafer',1,'A Ramon Wafer is a modified stroopwaffle which is a thin, round wafer made from two layers of sweet baked dough held together by caramel filling. Also has Ramons face from a hot press on it.',4.99,'stroopwafer.png');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) 
